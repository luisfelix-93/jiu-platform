    ...
    return (
        <div className="space-y-6">
            <header className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-neutral-800">Administração de Turmas</h2>
                    <p className="text-neutral-500">Crie, edite e gerencie todas as turmas da academia.</p>
                </div>
                    ...
                    <Card key={cls.id} className="hover:shadow-md transition-shadow">
                        ...
                        <CardContent>
                            <div className="space-y-3">
                                ...
                                <div className="flex items-center text-sm text-neutral-600 gap-2 mt-2">
                                    <Button
                                        variant="ghost"
                                        className="text-sm text-neutral-600 gap-2 hover:text-primary px-0 h-auto font-normal"
                                        onClick={() => setEnrollmentClass(cls)}
                                    >
