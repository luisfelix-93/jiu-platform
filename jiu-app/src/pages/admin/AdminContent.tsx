    ...
    return (
        <div className="space-y-6">
            <header className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-neutral-800">Administração de Conteúdo</h2>
                    <p className="text-neutral-500">Gerencie a biblioteca de vídeos e materiais técnicos.</p>
                </div>
